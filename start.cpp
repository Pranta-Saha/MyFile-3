...
public:
        ...
        double sumxy()
        {
                ...
                for(i=0;i<n;i++)
                {
                        tmp+=(2.303*log10(xx[i])*2.303*log10(yy[i]));
                }
                return tmp;
        }
        ...
        double sumxx()
        {
                ...
                for(i=0;i<n;i++)
                {
                        tmp+=(2.303*log10(xx[i])*2.303*log10(xx[i]));
                }
                return tmp;
        }
        ...
        {
                double a,b,nn=n,fx;
                b= ((nn*sumxy())-(sumx()*sumy()))/((nn*sumxx())-(sumx()*sumx()));
                double lna= (sumy()-(b*sumx()))/nn;
                cout<<lna<<endl;
                a=exp(lna);
                cout<<"y = "<<fixed<<setprecision(5)<<a<<"x^"<<fixed<<setprecision(5)<<b;
        }
